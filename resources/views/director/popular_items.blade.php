    ...
    <div class="d-flex flex-column justify-content-between min-vh-100">
        ...
        <main class="flex-grow-1 py-3">
            <div class="container">
                ...
                <h1>Создать отчет о популярных позициях меню</h1>
                
                <form action="{{ route('director.generatePopularItemsReport') }}" method="GET">
                    @csrf
                ...
                @if(isset($reportData) && count($reportData) > 0)
                    <div class="mb-3">
                        <a href="{{ route('director.downloadPopularItemsPdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}" class="btn btn-primary">Скачать PDF</a>
                    </div>
                    <br>
                    <div class="table-responsive no-padding">
                        <table id="popularItemsTable" class="text-center table-striped">
                            <thead>
                                <tr>
