<header class="py-3 border-bottom">
    <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top">
        <div class="container text-center">
            <a class="navbar-brand" href="{{ route('master') }}"><img src="/img/Logo.png" width="50" height="50" alt="Logo"></a>

            <ul class="navbar-nav me-auto mb-s mb-mb-0">
                <li class="nav-item">
                    <a class="nav-link {{Route::is('my.orders') ? 'active' : ''}}" aria-current="page"
                        href="{{ route('my.orders') }}">Мои заказы</a>
                </li>
            </ul>
