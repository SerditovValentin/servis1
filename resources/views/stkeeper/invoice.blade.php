...
<head>
    ...
    <style>
        ...
        .signature-line { 
            ...
            width: 200px; 
            display: inline-block; /* Делаем линию подписи inline-элементом */
            margin-left: 10px; /* Добавляем отступ между ФИО и линией подписи */
        }
        .responsible { 
            display: inline-block; /* Делаем ФИО inline-элементом */
        }
    </style>
</head>
<body>
    <div class="header">Приходная накладная</div>
    <p><strong>Организация: ООО "Сервисный центр"</strong>
