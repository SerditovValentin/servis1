...
Route::middleware(['auth', 'role:Сервисный инженер'])->group(function () {
    Route::get('master', [MasterController::class, 'index'])->name('master');
    Route::post('/orders/{id}/take', [MasterController::class, 'takeOrder'])->name('orders.take');
    Route::get('/my-orders', [MasterController::class, 'myOrders'])->name('my.orders');
    Route::post('/repair/parts/store', [MasterController::class, 'store'])->name('repair.parts.store');
    Route::post('/repair/{id}/complete', [MasterController::class, 'completeRepair'])->name('repair.complete');
